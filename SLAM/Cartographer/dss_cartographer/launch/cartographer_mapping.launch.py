"""
Cartographer 2D SLAM Launch File for DSS Platform
LiDAR-only mapping (no IMU due to DSS IMU bug)
"""
...
def generate_launch_description():
    ...
    cartographer_node = Node(
        ...
        arguments=[
            ...
            '-configuration_basename', 'dss_2d.lua'
        ],
        remappings=[
            ('scan', '/scan'),
        ]
    ...
    # Cartographer occupancy grid node (for map visualization)
